...
exports.createSubscription = function(req, res) {
    var bla = { email: req.params.email, repourl: req.params.repourl };
    res.send(JSON.stringify(bla));

//    executeQuery('INSERT INTO subscriptions values('+req.params.email+','+req.params.repourl+')', res);
};
